...
The system SHALL allow a user to create a new game room of type 'TroChoiMini' or 'VeCungBan'. The creator becomes the host (Chủ phòng).
...
Users SHALL be able to join an active room either by entering a specific room code or via random matchmaking ('GhepNgauNhien').
